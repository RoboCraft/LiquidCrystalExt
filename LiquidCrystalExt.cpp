/* This is the implementation of LiquidCrystalExt library.
 *
...
void LiquidCrystalBase::begin(uint8_t cols, uint8_t lines, uint8_t dotsize)
{
  if (lines > 1)
...
void LiquidCrystalBase::createChar(uint8_t location, uint8_t charmap[])
{
